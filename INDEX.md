...
| VoiceKind (37) / LookaheadBudget::phase_2b_1 (72) / phase_2b_2 (89) / FlushDirection (122) / STAGGER_DOWN (133) / stagger_order (151) / FlushReport (160) / drain_rhythm_ring (195) / drain_melody_ring (218) / drain_harmony_ring (243) / drain_texture_ring (268) / compose_drums_ahead (293) / compose_melody_ahead (330) / compose_bass_ahead (369) / compose_chord_ahead (396) / compose_pad_ahead (438) | rust/src/workers.rs | 37 | Per-voice lookahead budgets (2b-1 + 2b-2 presets) + plan-flush protocol + 4-voice prototype composers (#81 #82) |
| VoicingStyle (15) / CollisionMode (33) / Voicing (293) / extension_semitones (44) / build_style (75) / break_parallel_motion (227) / voice_lead (213) / enforce_register (263) / enforce_collision (300) / voice (318) / has_parallel_fifths_or_octaves (363) | rust/src/voicing_engine.rs | 15 | First Rust impl of SPEC_040 §3/§5/§6 — per-palette voicing style, phase-driven extensions, register/critical-band rules, collision avoidance, greedy parsimonious voice leading (#82) |
| VoicingStyle (200) / CollisionMode (220) / VoicingProfile (236) / HarmonicRhythm (256) / Palette.voicing (282) / Palette.harmonic_rhythm (286) | rust/src/palette.rs | 200 | SPEC_040 §3.4 voicing profile + §4.3 harmonic rhythm tables on all 10 palettes (#82) |
| flags::voicing_engine (179) / harmonic_rhythm / walking_bass_next_chord / cadential_planning / lookahead_all_voices / enable_all_2b2 (231) / disable_all_2b2 (240) | rust/src/config.rs | 175 | Phase 2b-2 algorithm-upgrade feature flags. Default off → byte-identical to #81. CLI: `--enable-2b2` (#82) |
| HarmonyEngine.update_beats_per_chord (134) / peek_next_chord (164) / beats_until_next_chord (171) | rust/src/harmony.rs | 134 | SPEC_040 §4 dynamic beats-per-chord on phase change + next-chord lookahead for WalkingBass (#82) |
| WalkingBass.pick_note (407 — next-chord branch) | rust/src/sequencer.rs | 407 | Next-chord approach-tone bias on the last beat of current chord when `flags::walking_bass_next_chord()` is on (#82) |
| MelodyEngine.last_note_midi (191) / apply_cadential_bias (376) | rust/src/melody.rs | 191 | Last-note getter (VoicingEngine collision input) + phrase-end cadential resolution bias (#82) |
...
Phase 2a (#60) complete — per-voice threads + all 10 palettes. Phase 2b (#61): #81 flush protocol + drums/melody prototype done; #82 bass/chord/pad lookahead + VoicingEngine + harmonic rhythm + WalkingBass next-chord + cadential planning all built behind feature flags (default off; CLI `--enable-2b2` to listen).
