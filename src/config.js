...
const CFG = {
  ...
  DIAGNOSTIC: {
    ...
    enabled: {
      ...
      pumpDetect: true,
      voiceFlood: true,
      voiceStealStorm: true,
      voiceLeak: true,
      lowEndStack: true,
      flatDynamics: true,
    },
    CLIP_TRACK_MAX: 1.0,
    CLIP_MASTER_MAX: 0.95,
    CLIP_LIMITER_DB: 6,
    GAIN_SPIKE_DELTA: 0.3,
    SILENCE_DROP_THRESHOLD: 0.2,
    PUMP_RANGE: 0.4,
    PUMP_WINDOW: 4,
    VOICE_FLOOD_THRESHOLD: 14,
    VOICE_STEAL_MAX: 4,
    VOICE_LEAK_BEATS: 8,
    LOW_END_STACK_GAIN: 0.5,
    LOW_END_STACK_MAX_PHASE: 'swell',
    FLAT_DC_DELTA: 0.05,
    FLAT_DC_BEATS: 16,
  },
};
